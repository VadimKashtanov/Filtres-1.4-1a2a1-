...
#
nvcc -c impl/main/performances.cu ${A} &
#	/etc
...
nvcc -c impl/opti/opti_super.cu  ${A} &
#
...
nvcc *.o -o main ${A}
#	Compilation prog tier n0
#rm main.o; nvcc -c impl/prog0.cu ${A}
#nvcc *.o -o prog0 ${A}
